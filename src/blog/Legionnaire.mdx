...
description: >-
  ...
  It operates as a modular, GUI-less client running in the background,
  consisting of a client, a control-server and web dashboard. Our team built it
  in <48 Hours for the UQCS Hackathon 2025.
keywords: 'AI SIEM, XGBoost, Hackathon, Cyber Security, UQCS, Legionnaire, Python, React'
...
Given the goal is to make an enterprise-level product, the Client will be a
...
What I can contribute? is that it actually worked surprisingly well. Resource
...
activities of network connections, without intercepting, packet inspection,? or
